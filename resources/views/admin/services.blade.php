          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Table Produk Services</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="{{ url('/services/create_services') }}" class="btn btn-success mb-3"><i class="fa-solid fa-plus mr-2"></i>TAMBAH
                DATA</a>
