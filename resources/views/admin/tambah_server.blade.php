...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Produk (Server)</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Tambah Data Produk (Server)</h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ url('/server/store_server') }}" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama Server</label>
                  <input type="text" name="nama_produk" class="form-control" placeholder="Nama Server">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
