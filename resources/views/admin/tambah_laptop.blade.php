    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ url('/laptop/store_laptop') }}" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama Laptop</label>
                  <input type="text" name="nama_produk" class="form-control" placeholder="Nama Laptop">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
