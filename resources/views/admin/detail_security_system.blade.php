          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h2 class="card-title" style="font-weight: bold">Detail Produk Security System</h2>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
               ...
               <div class="row">
                ...
                <a href="{{ route('admin/security_system') }}"><button type="button" class="btn btn-danger mt-4">Kembali</button></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
