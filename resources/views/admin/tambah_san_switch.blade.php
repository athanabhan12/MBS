...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambah Data Produk (San Switch)</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin/index') }}">Home</a></li>
              <li class="breadcrumb-item active">Tambah San Switch</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Tambah Data Produk (San Switch)</h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ url('/san_switch/store_san_switch') }}" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama San Switch</label>
                  <input type="text" name="nama_produk" class="form-control" placeholder="Nama San Switch">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
