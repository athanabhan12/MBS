...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div id="logo">
        <h1><a href="index.html">MBS<span>CORP</span></a></h1>
  ...
  <section id="beranda">
    ...
    <div class="hero-content" data-aos="fade-up">
      <h2>MBS CORP.<br><span>IT Solution Provider</span><br></h2>
      <div>
        <p style="font-family: Arial, Helvetica, sans-serif; font-weight: bold;">
            Customer Satisfaction is Our Responsibility</p>
      </div>
    </div>

    <div class="hero-slider swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide" style="background-image: url('user/assets/img/hero-carousel/1.jpg');"></div>
        <div class="swiper-slide" style="background-image: url('user/assets/img/hero-carousel/2.jpg');"></div>
        <div class="swiper-slide" style="background-image: url('user/assets/img/hero-carousel/3.jpg');"></div>
        <div class="swiper-slide" style="background-image: url('user/assets/img/hero-carousel/4.jpg');"></div>
        <div class="swiper-slide" style="background-image: url('user/assets/img/hero-carousel/5.jpg');"></div>
      </div>
    </div>
