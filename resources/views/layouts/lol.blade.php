...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/our_team" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/platform_partnership" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/project_reference" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/finance_banking" class="nav-link">
                    <i class="fa-solid fa-coins"></i>
                  <p>Finance & Banking</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/goverment" class="nav-link">
                    <i class="fa-solid fa-building-flag"></i>
                  <p>Goverment</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/non_goverment" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/printer" class="nav-link">
                    <i class="far fa-solid fa-print"></i>
                  <p>Printer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="security_system" class="nav-link">
              ...
              <li class="nav-item">
                <a href="/san_switch" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Since 2017 - www.mbsonline.id</strong>
    <div class="float-right d-none d-sm-inline-block">
      <b>IT Solution Provider</b>
    </div>
  </footer>
