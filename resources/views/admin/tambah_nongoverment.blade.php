    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form action="{{ url('/non_goverment/store') }}" method="POST" enctype="multipart/form-data">
              @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama Client</label>
                  <input type="text" name="nama_nongoverment" class="form-control" placeholder="Nama Client">
                </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
